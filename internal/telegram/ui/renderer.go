...
func NewRenderer(renderers map[entities.Screen]renderers.Renderer) *Renderer {
	return &Renderer{
		renderers: renderers,
	}
}

func (v *Renderer) Render(ctx context.Context, chatID int64, state entities.UIState) (entities.Rendered, error) {
